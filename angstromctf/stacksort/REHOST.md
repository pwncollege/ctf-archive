...
Files can be found here: [angstromctf](https://github.com/blairsec/challenges/tree/master/angstromctf/2024/pwn/stacksort)
...
```
patchelf --set-rpath /challenge /challenge/stacksort
```