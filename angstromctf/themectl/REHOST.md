...
Files can be found here: [angstromctf](https://github.com/blairsec/challenges/tree/master/angstromctf/2024/pwn/themectl)
...
```
patchelf --set-rpath /challenge /challenge/themectl
```