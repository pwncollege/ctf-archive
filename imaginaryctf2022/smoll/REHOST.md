...
Files can be found here: [ImaginaryCTF 2022](https://github.com/sajjadium/ctf-archives/tree/main/ctfs/ImaginaryCTF/2022/crypto/smoll)

## Challenge Setup
There are no dependecy files for `smoll.py` and `output.txt`.
