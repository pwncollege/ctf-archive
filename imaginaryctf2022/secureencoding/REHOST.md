...
Files can be found here: [ImaginaryCTF 2022](https://github.com/sajjadium/ctf-archives/tree/main/ctfs/ImaginaryCTF/2022/crypto/SecureEncodingBase64)

## Challenge Setup
There are no dependecy files for `encode.py` and `out.txt`.
