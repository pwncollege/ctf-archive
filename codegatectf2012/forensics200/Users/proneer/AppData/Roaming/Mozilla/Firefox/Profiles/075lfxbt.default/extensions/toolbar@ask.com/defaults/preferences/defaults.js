...
pref("extensions.asktb.tb", "PTV");  // installer populates this during install time
pref("extensions.asktb.v", "3.11.3.15590");
pref("extensions.asktb.r", "1");
pref("extensions.asktb.build", "15590"); // build system populates this
pref("extensions.asktb.id", "0408A1BF-298A-4A87-ADAE-C01FC6A2354F");   // installer populated this GUID during install time
pref("extensions.asktb.sa-enabled", "false");
pref("extensions.asktb.said", "");
...
pref("extensions.asktb.dtid", "");
pref("extensions.asktb.hpr-enabled", "0");
pref("extensions.asktb.hpr-url", "");
...
pref("extensions.asktb.tb-macros-reg-loc", "Software\AskToolbar\Macro");
pref("extensions.asktb.update-reg-loc", "Software\AppDataLow\Software\AskToolbar\Update");
...
pref("extensions.asktb.first-launch-url", "");
...
pref("general.useragent.extra.asktb", "AskTbPTV/3.11.3.15590");
