...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	<xsl:template match="/">
		<DEBUGGERCONTAINER xmlns:dt="urn:schemas-microsoft-com:datatypes" Protected="false">
			<DEBUGGER ID="ProcessList">
				<PROPERTYCONTAINER>
					...
					<PROPERTY ID="_AddonFile" Name="_AddonFile">Microsoft.VisualStudio.Debugging.xsl</PROPERTY></PROPERTYCONTAINER>
			</DEBUGGER>
