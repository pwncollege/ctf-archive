...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	<xsl:template match="/">
		<TYPEMAPCONTAINER xmlns:dt="urn:schemas-microsoft-com:datatypes" Protected="false">
			<TYPEMAP ID="default">
				<QISCONTAINER>
					<QIS ID="2577">
						<PROPERTYCONTAINER>
					...
					<QIS ID="16973824">
						<PROPERTYCONTAINER>
							<PROPERTY ID="default" Protected="true">MIPSIV</PROPERTY>
						</PROPERTYCONTAINER>
					</QIS>
					<QIS ID="16973825">
						<PROPERTYCONTAINER>
				...
				<PROPERTYCONTAINER>
					<PROPERTY ID="_AddonFile" Name="_AddonFile">Microsoft.TypeMaps.xsl</PROPERTY></PROPERTYCONTAINER>
			</TYPEMAP>
		</TYPEMAPCONTAINER>
	</xsl:template>
</xsl:stylesheet>
