...
use WPMailSMTP\Vendor\Google\Auth\CredentialSource\AwsNativeSource;
use WPMailSMTP\Vendor\Google\Auth\CredentialSource\FileSource;
use WPMailSMTP\Vendor\Google\Auth\CredentialSource\UrlSource;
use WPMailSMTP\Vendor\Google\Auth\ExternalAccountCredentialSourceInterface;
use WPMailSMTP\Vendor\Google\Auth\FetchAuthTokenInterface;
use WPMailSMTP\Vendor\Google\Auth\GetQuotaProjectInterface;
use WPMailSMTP\Vendor\Google\Auth\GetUniverseDomainInterface;
