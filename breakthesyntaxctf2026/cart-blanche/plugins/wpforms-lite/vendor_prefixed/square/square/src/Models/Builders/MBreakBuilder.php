...
use WPForms\Vendor\Square\Models\MBreak;
/**
...
class MBreakBuilder
{
     ...
     * @param bool $isPaid
     */
    public static function init(string $startAt, string $breakTypeId, string $name, string $expectedDuration, bool $isPaid) : self
    {
