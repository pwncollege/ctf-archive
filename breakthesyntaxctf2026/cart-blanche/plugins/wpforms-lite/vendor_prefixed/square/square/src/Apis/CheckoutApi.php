...
use WPForms\Vendor\Square\Models\CreateCheckoutRequest;
use WPForms\Vendor\Square\Models\CreateCheckoutResponse;
use WPForms\Vendor\Square\Models\CreatePaymentLinkRequest;
use WPForms\Vendor\Square\Models\CreatePaymentLinkResponse;
use WPForms\Vendor\Square\Models\DeletePaymentLinkResponse;
use WPForms\Vendor\Square\Models\ListPaymentLinksResponse;
use WPForms\Vendor\Square\Models\RetrieveLocationSettingsResponse;
...
use WPForms\Vendor\Square\Models\UpdateLocationSettingsRequest;
use WPForms\Vendor\Square\Models\UpdateLocationSettingsResponse;
...
use WPForms\Vendor\Square\Models\UpdatePaymentLinkResponse;
class CheckoutApi extends BaseApi
{
    ...
    public function createCheckout(string $locationId, CreateCheckoutRequest $body) : ApiResponse
    {
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/locations/{location_id}/checkouts')->auth('global')->parameters(TemplateParam::init('location_id', $locationId), HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/online-checkout/location-settings/{location_id}')->auth('global')->parameters(TemplateParam::init('location_id', $locationId));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/v2/online-checkout/location-settings/{location_id}')->auth('global')->parameters(TemplateParam::init('location_id', $locationId), HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/online-checkout/merchant-settings')->auth('global');
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/v2/online-checkout/merchant-settings')->auth('global')->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/online-checkout/payment-links')->auth('global')->parameters(QueryParam::init('cursor', $cursor), QueryParam::init('limit', $limit));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/online-checkout/payment-links')->auth('global')->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/v2/online-checkout/payment-links/{id}')->auth('global')->parameters(TemplateParam::init('id', $id));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/online-checkout/payment-links/{id}')->auth('global')->parameters(TemplateParam::init('id', $id));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/v2/online-checkout/payment-links/{id}')->auth('global')->parameters(TemplateParam::init('id', $id), HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
