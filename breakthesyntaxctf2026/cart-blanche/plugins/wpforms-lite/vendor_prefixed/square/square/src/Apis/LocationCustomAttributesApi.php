...
use WPForms\Vendor\Square\Models\BulkDeleteLocationCustomAttributesResponse;
use WPForms\Vendor\Square\Models\BulkUpsertLocationCustomAttributesRequest;
use WPForms\Vendor\Square\Models\BulkUpsertLocationCustomAttributesResponse;
use WPForms\Vendor\Square\Models\CreateLocationCustomAttributeDefinitionRequest;
use WPForms\Vendor\Square\Models\CreateLocationCustomAttributeDefinitionResponse;
...
use WPForms\Vendor\Square\Models\ListLocationCustomAttributeDefinitionsResponse;
...
use WPForms\Vendor\Square\Models\UpdateLocationCustomAttributeDefinitionRequest;
use WPForms\Vendor\Square\Models\UpdateLocationCustomAttributeDefinitionResponse;
use WPForms\Vendor\Square\Models\UpsertLocationCustomAttributeRequest;
use WPForms\Vendor\Square\Models\UpsertLocationCustomAttributeResponse;
class LocationCustomAttributesApi extends BaseApi
{
     ...
     */
    public function listLocationCustomAttributeDefinitions(?string $visibilityFilter = null, ?int $limit = null, ?string $cursor = null) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/locations/custom-attribute-definitions')->auth('global')->parameters(QueryParam::init('visibility_filter', $visibilityFilter), QueryParam::init('limit', $limit), QueryParam::init('cursor', $cursor));
        $_resHandler = $this->responseHandler()->type(ListLocationCustomAttributeDefinitionsResponse::class)->returnApiResponse();
     ...
     * @return ApiResponse Response from the API call
     */
    public function createLocationCustomAttributeDefinition(CreateLocationCustomAttributeDefinitionRequest $body) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/locations/custom-attribute-definitions')->auth('global')->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
        $_resHandler = $this->responseHandler()->type(CreateLocationCustomAttributeDefinitionResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/v2/locations/custom-attribute-definitions/{key}')->auth('global')->parameters(TemplateParam::init('key', $key));
        $_resHandler = $this->responseHandler()->type(DeleteLocationCustomAttributeDefinitionResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/locations/custom-attribute-definitions/{key}')->auth('global')->parameters(TemplateParam::init('key', $key), QueryParam::init('version', $version));
        $_resHandler = $this->responseHandler()->type(RetrieveLocationCustomAttributeDefinitionResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
     ...
     * @return ApiResponse Response from the API call
     */
    public function updateLocationCustomAttributeDefinition(string $key, UpdateLocationCustomAttributeDefinitionRequest $body) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/v2/locations/custom-attribute-definitions/{key}')->auth('global')->parameters(TemplateParam::init('key', $key), HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
        $_resHandler = $this->responseHandler()->type(UpdateLocationCustomAttributeDefinitionResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/locations/custom-attributes/bulk-delete')->auth('global')->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
        $_resHandler = $this->responseHandler()->type(BulkDeleteLocationCustomAttributesResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/locations/custom-attributes/bulk-upsert')->auth('global')->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
        $_resHandler = $this->responseHandler()->type(BulkUpsertLocationCustomAttributesResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
     ...
     * @return ApiResponse Response from the API call
     */
    public function listLocationCustomAttributes(string $locationId, ?string $visibilityFilter = null, ?int $limit = null, ?string $cursor = null, ?bool $withDefinitions = \false) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/locations/{location_id}/custom-attributes')->auth('global')->parameters(TemplateParam::init('location_id', $locationId), QueryParam::init('visibility_filter', $visibilityFilter), QueryParam::init('limit', $limit), QueryParam::init('cursor', $cursor), QueryParam::init('with_definitions', $withDefinitions));
        $_resHandler = $this->responseHandler()->type(ListLocationCustomAttributesResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/v2/locations/{location_id}/custom-attributes/{key}')->auth('global')->parameters(TemplateParam::init('location_id', $locationId), TemplateParam::init('key', $key));
        $_resHandler = $this->responseHandler()->type(DeleteLocationCustomAttributeResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
     ...
     * @return ApiResponse Response from the API call
     */
    public function retrieveLocationCustomAttribute(string $locationId, string $key, ?bool $withDefinition = \false, ?int $version = null) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/locations/{location_id}/custom-attributes/{key}')->auth('global')->parameters(TemplateParam::init('location_id', $locationId), TemplateParam::init('key', $key), QueryParam::init('with_definition', $withDefinition), QueryParam::init('version', $version));
        $_resHandler = $this->responseHandler()->type(RetrieveLocationCustomAttributeResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
     ...
     * @return ApiResponse Response from the API call
     */
    public function upsertLocationCustomAttribute(string $locationId, string $key, UpsertLocationCustomAttributeRequest $body) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/locations/{location_id}/custom-attributes/{key}')->auth('global')->parameters(TemplateParam::init('location_id', $locationId), TemplateParam::init('key', $key), HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
        $_resHandler = $this->responseHandler()->type(UpsertLocationCustomAttributeResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
}
