...
class HTMLPurifier_HTMLModuleManager
{
     ...
     * @type array
     */
    public $prefixes = array('WPForms\Vendor\HTMLPurifier_HTMLModule_');
    /**
     ...
     *          - Check for WPForms\Vendor\HTMLPurifier_HTMLModule_$name
        ...
        foreach ($this->modules as $module) {
            ...
            foreach ($module->info_injector as $injector) {
                if (!\is_object($injector)) {
                    $class = "WPForms\Vendor\HTMLPurifier_Injector_{$injector}";
                    $injector = new $class();
                }
